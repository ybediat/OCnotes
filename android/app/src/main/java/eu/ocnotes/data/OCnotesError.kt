...
class OCnotesException(
    ...
    companion object {
         ...
         */
        fun from(t: Throwable): OCnotesException {
            if (t is OCnotesException) return t
            val message = t.message.orEmpty()
            val code = Mobile.errorCode(message)
            return OCnotesException(categorieDuCode(code), code, message, t)
        }
    }
}
