...
/**
 * Miroirs Kotlin des formats JSON échangés avec la façade Go.
 *
...
object BlockKind {
    ...
    /**
     * Saut de page explicite d'un `.docx` ou d'un `.odt`.
     *
     * Sans champ : l'aperçu dessine un repère à sa place. Une note n'en produit
     * jamais — le Markdown n'a pas de saut de page.
     */
    const val SAUT_DE_PAGE = "pagebreak"
}
...
object SpanStyleId {
     ...
     * Surligné.
     *
     * Même origine que [SOULIGNE] : seulement les documents. La couleur du
     * document ne traverse pas la façade — un passage est marqué, ou il ne
     * l'est pas — donc l'aperçu choisit sa propre teinte.
     */
    const val SURLIGNE = "highlight"
}
