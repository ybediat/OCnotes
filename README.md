...
La version signée **0.1.5** est disponible sur la
[page des releases](https://github.com/ybediat/OCnotes/releases/tag/v0.1.5)
(téléchargement :
[`OCnotes-0.1.5.apk`](https://github.com/ybediat/OCnotes/releases/download/v0.1.5/OCnotes-0.1.5.apk)).
