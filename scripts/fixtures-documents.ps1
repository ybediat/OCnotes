...
# correspondance du chantier : six niveaux de titre, les cinq mises en forme
# en ligne (gras, italique, souligné, barré, surligné), un lien, une liste à
# puces, une liste numérotée imbriquée, un tableau à en-tête, et un saut de
# page explicite.
#
...
#
# Le surlignage part d'un `background-color` HTML : LibreOffice en fait un
# `w:shd`/`fo:background-color` sur le run, pas un `w:highlight` — l'analyseur
# lit les deux. Le saut de page part d'un `page-break-before` sur un paragraphe
# isolé : un style automatique le porte, ce qui évite de casser une page à
# chaque titre.
$ExempleHtml = @'
<!DOCTYPE html>
<html>
...
<p>Du texte <b>en gras</b> puis <i>en italique</i>, du <u>souligne</u>, du
<s>barre</s> et du <span style="background-color: #ffff00">surligne</span>,
enfin un <a href="https://opencloud.eu/">lien vers OpenCloud</a> suivi d'un
point final.</p>
...
<p style="page-break-before: always">Un dernier paragraphe, apres le saut de
page.</p>
</body>
</html>
'@
