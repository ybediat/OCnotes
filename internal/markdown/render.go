...
const (
	...
	// KindPageBreak marque un saut de page explicite. Le Markdown n'en a pas :
	// il ne sort que d'un .docx ou d'un .odt, où l'auteur l'a posé à la main.
	// Le bloc ne porte aucun champ — l'aperçu dessine un repère à sa place.
...
const (
	...
	// StyleHighlight marque un passage surligné. Comme StyleUnderline, il ne
	// peut pas venir d'une note — le Markdown n'a pas de surlignage — et ne
	// sort que d'un .docx ou d'un .odt. La couleur du document ne traverse
	// pas : un passage est « marqué » ou il ne l'est pas.
